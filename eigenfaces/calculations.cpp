...
{
    cv::Mat restored(reducedEigenvectors.rows, meanSubtractedImages.cols, CV_64F);
...
void preprocessTestImages(cv::Mat testImage, const cv::Mat meanImage)
{
    testImage -= meanImage;
                     ...
                     )
{
    ...
    preprocessTestImages(testImage, meanImage);
